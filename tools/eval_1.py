...
def get_args():
    ...
    parser.add_argument("--ckpt_path", type=str, required=False, default='/mnt/nvme0n1p5/projects/hackathon/CP2/tools/mnist/ddpm_ckpt_clalatentss_cond.pth')
    parser.add_argument("--real_data_dir", type=str, required=False, default='/mnt/nvme0n1p5/projects/hackathon/CP2/data/mnist/train/Validation/A')
    parser.add_argument("--gen_data_dir", type=str, required=False, default='/mnt/nvme0n1p5/projects/hackathon/CP2/tools/mnist/cond_class_samples/1')
    parser.add_argument("--batch_size", type=int, required=False, default=64)
    parser.add_argument("--n_eval_imgs", type=int, required=False, default=392)
...
class Evaluator(object):
    def __init__(self, ddpm, n_eval_imgs, batch_size, real_dl, gen_dl, mode, device):
        ...
        self.ddpm = Unet(im_channels=autoencoder_model_config['z_channels'],
        ...
        self.mode = mode
        self.device = device
        self.ddpm.load_state_dict(torch.load(ddpm, map_location=device))
        self.ddpm.eval()
...
if __name__ == "__main__":
    ...
    evaluator = Evaluator(
        ...
        args.real_data_dir,
        args.gen_data_dir,
        mode="both",  # or "is" for Inception Score only
        device=torch.device("cuda" if torch.cuda.is_available() else "cpu"),
    )

    # Evaluate and print FID and Inception Score
    evaluator.evaluate()
