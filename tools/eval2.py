...
def infer(args,i):
    ...
    with torch.no_grad():
        sample(model, scheduler, train_config, diffusion_model_config,
               autoencoder_model_config, diffusion_config, dataset_config, vae,9,1)

    os.rename(os.path.join(train_config['task_name'], 'cond_class_samples', 'x0_0.png'), os.path.join(train_config['task_name'], 'cond_class_samples', '2', f'opt0_{i}.png'))
